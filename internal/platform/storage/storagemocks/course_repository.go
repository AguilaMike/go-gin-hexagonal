...
func (_m *CourseRepository) GetByID(ctx context.Context, id string) (*mooc.Course, error) {
	ret := _m.Called(ctx, id)

	var r0 *mooc.Course
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string) (*mooc.Course, error)); ok {
		return rf(ctx, id)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string) *mooc.Course); ok {
		r0 = rf(ctx, id)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*mooc.Course)
